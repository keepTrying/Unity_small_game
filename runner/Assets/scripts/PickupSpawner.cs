...
public class PickupSpawner : MonoBehaviour
{
	...
	public float highHealthThreshold = 100f;		// The health of the player, above which only bomb crates will be delivered.
	public float lowHealthThreshold = 90f;		// The health of the player, below which only health crates will be delivered.
